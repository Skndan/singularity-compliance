      ...
      <div className="space-y-4 py-4 flex flex-col h-full">
        <div className="px-3 py-2 flex-1">
          <Link href="/dashboard" className="flex items-center pl-3 mb-14">
            <Image src="/mirror-dark.svg" className="hidden dark:block" width={180} height={56} alt="Logo" />
            <Image src="/mirror-light.svg" className="block dark:hidden" width={180} height={56} alt="Logo" />
          </Link>
